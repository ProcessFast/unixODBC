...
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/config.h.in \
	$(srcdir)/unixodbc_conf.h.in AUTHORS COPYING ChangeLog INSTALL \
...
ACLOCAL = ${SHELL} /tmp/unixODBC-2.3.7/missing aclocal-1.15
ALLOCA = 
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AS = as
AUTOCONF = ${SHELL} /tmp/unixODBC-2.3.7/missing autoconf
AUTOHEADER = ${SHELL} /tmp/unixODBC-2.3.7/missing autoheader
AUTOMAKE = ${SHELL} /tmp/unixODBC-2.3.7/missing automake-1.15
AWK = gawk
BIN_PREFIX = /usr/bin
CC = gcc
...
FGREP = /bin/grep -F
GREP = /bin/grep
ICONV_CHAR_ENCODING = UTF8
ICONV_UNICODE_ENCODING = UTF16LE
...
LDFLAGS = 
LEX = ${SHELL} /tmp/unixODBC-2.3.7/missing flex
LEXLIB = 
LEX_OUTPUT_ROOT = 
LFLAGS = 
LIBADD_CRYPT = -lcrypt
...
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} /tmp/unixODBC-2.3.7/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
YACC = yacc
YFLAGS = 
abs_builddir = /tmp/unixODBC-2.3.7
abs_srcdir = /tmp/unixODBC-2.3.7
abs_top_builddir = /tmp/unixODBC-2.3.7
abs_top_srcdir = /tmp/unixODBC-2.3.7
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /tmp/unixODBC-2.3.7/install-sh
libdir = /usr/lib64
